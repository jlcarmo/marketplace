...
public class MarketplaceService {
  ...
  public static final String UNAUTHORIZED_ACCESS = "Unauthorized Access. "
                                                   + "Your Pentaho roles do not allow you to make changes to plugins.";
  ...
  public StatusMessage uninstallPlugin( String id ) throws MarketplaceSecurityException {
    ...
    return new StatusMessage( "PLUGIN_UNINSTALLED", toUninstall.getName(  )
  ...
  public StatusMessage installPlugin( String id, String versionBranch ) throws MarketplaceSecurityException {
    ...
    if ( versionBranch != null && versionBranch.length(  ) > 0 ) {
      ...
      return new StatusMessage( "FAIL", "Version " + versionBranch + " not found for plugin " + id
          + ", see log for details." );
    }
    ...
    return new StatusMessage( "PLUGIN_INSTALLED", toInstall.getName(  )
  ...
  public String installPluginJson( @PathParam( "pluginId" ) String pluginId,
    ...
    try {
      ...
      return createJsonMessage( UNAUTHORIZED_ACCESS, "ERROR_0002_UNAUTHORIZED_ACCESS" );
    }
  }
  ...
  protected boolean withinParentVersion( PluginVersion pv ) {
    ...
    return new VersionData( v ).within( new VersionData( pv.getMinParentVersion(  ) ),
        new VersionData( pv.getMaxParentVersion(  ) ) );
  }
  ...
  /**
   * This method determines the installed version of a plugin.
   * If the plugin doesn't define a version correctly, it returns "Unknown".
